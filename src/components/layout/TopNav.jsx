...
import { Bell, Search, Plus, User, Menu, CheckSquare, StickyNote, Calendar, Activity, Bookmark, Timer, LayoutGrid, Command as CommandIcon, LogOut } from 'lucide-react';
...
export default function TopNav({ onMenuClick }) {
  ...
  const { setWidgetSelectorOpen, setCommandPaletteOpen, openCreateModal } = useUIStore();
      ...
      <div className="flex items-center gap-2 md:gap-4">
        <DropdownMenu>
          <DropdownMenuTrigger render={
            <Button variant="outline" size="sm" className="hidden sm:flex gap-2 h-9 px-4 rounded-md">
              <Plus size={16} />
          ...
          <DropdownMenuContent className="w-56" align="end">
            ...
            <DropdownMenuItem onSelect={() => openCreateModal('note')}>
              <StickyNote size={14} className="mr-2" />
              <span>Note</span>
            </DropdownMenuItem>
            <DropdownMenuItem onSelect={() => openCreateModal('event')}>
